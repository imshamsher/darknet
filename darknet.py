...
- Set global vnetwork_widthariable DARKNET_FORCE_CPU to True
...
if os.name == "nt":
    ...
    lib = CDLL("./libdarknet.so", RTLD_GLOBAL)
    #lib = CDLL("./Modules/Processing_modules/libdarknet.so", RTLD_GLOBAL)
...
def detect_image(net, meta, im, thresh=.5, hier_thresh=.5, nms=.45, debug=False):
    ...
    if debug: print("did nms sort and obj")
    res = []
    ...
    for j in range(num):
        ...
        for i in range(meta.classes):
            ...
            if dets[j].prob[i] > 0:
                ...
                res.append((nameTag, dets[j].prob[i], convertBack(b.x, b.y, b.w, b.h)))
